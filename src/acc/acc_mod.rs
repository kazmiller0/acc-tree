...
use super::digest::{Digest, Digestible};
...
use super::utils::{digest_to_prime_field, FixedBaseCurvePow, FixedBaseScalarPow};
...
impl Acc {
    ...
    pub fn update_element(
        ...
        let mid_acc = acc_proj.into_affine();
